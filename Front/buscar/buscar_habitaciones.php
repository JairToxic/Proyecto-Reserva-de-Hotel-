...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $capacidad = $_POST['numberOfPeople'];
...
<head>
     <!-- Site Title-->
    <title>Buscar_Habitaciones</title>
    ...
    <!-- Stylesheets-->
    <link rel="stylesheet" type="../site/text/css" href="//fonts.googleapis.com/css?family=Lato:400,700,400italic%7CPoppins:300,400,500,700">
...
<div class="ie-panel"><a href="http://windows.microsoft.com/en-US/internet-explorer/"><img src="../site/images/ie8-panel/warning_bar_0000_us.jpg" height="42" width="820" alt="You are using an outdated browser. For a faster, safer browsing experience, upgrade for free today."></a></div>
    <!-- Page-->
    <div class="text-center page"><a class="banner banner-top" href="https://www.templatemonster.com/website-templates/monstroid2.html" target="_blank"><img src="../site/images/monstroid.jpg" alt="" height="0"></a>
      <!-- Page preloader
          ...
          <nav class="rd-navbar rd-navbar-default-with-top-panel" data-layout="rd-navbar-fixed" data-sm-layout="rd-navbar-fixed" data-md-layout="rd-navbar-fullwidth" data-md-device-layout="rd-navbar-fixed" data-lg-layout="rd-navbar-fullwidth" data-lg-device-layout="rd-navbar-fullwidth" data-md-stick-up-offset="90px" data-lg-stick-up-offset="150px" data-stick-up="true" data-sm-stick-up="true" data-md-stick-up="true" data-lg-stick-up="true">
            <div class="rd-navbar-top-panel rd-navbar-collapse">
              <div class="rd-navbar-top-panel-inner">
                ...
                <div class="center-side">
                  <!-- RD Navbar Brand-->
                  <div class="rd-navbar-brand fullwidth-brand"><a class="brand-name" href="../site/index.html"><img src="../site/imagenes/logo.jpeg" alt="" width="214" height="28"/></a></div>
                </div>
            ...
            <div class="rd-navbar-inner">
              ...
              <div class="rd-navbar-panel">
                ...
                <!-- RD Navbar Brand-->
                <div class="rd-navbar-brand mobile-brand"><a class="brand-name" href="../site/index.html"><img src="../site/images/logo-default-314x48.png" alt="" width="314" height="48"/></a></div>
              </div>
              <div class="rd-navbar-aside-right">
                <div class="rd-navbar-nav-wrap">
                  <div class="rd-navbar-nav-scroll-holder">
                    <ul class="rd-navbar-nav">
                      <li class="active"><a href="../site/index.html">Hotel</a>
                      </li>
                      <li><a href="../site/about-us.html">Sobre Nosotros</a>
                      </li>
                      <li><a href="../site/contacts.html">Contactanos</a>
                      </li>
                      <li><a href="../site/habitaciones.html">Habitaciones</a>
                      </li>
                    </ul>
                  </div>
                </div>
