<?php
    ...
    if (isset($_GET['habitacion_id'])) {
        ...
        header("Location: ../tipo de habitaciones/habitaciones_suite.php");
        exit();
    }
?>
...
<br>
    ...
    <a href="../tipos de habitaciones/habitaciones_suite.php" class="btn btn-secondary">Volver a la lista de habitaciones</a>
</div>
<br>
