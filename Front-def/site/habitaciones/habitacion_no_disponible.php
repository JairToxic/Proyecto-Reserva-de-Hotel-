...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
  ...
  <body>
    ...
    <div class="confirmation-container">
        <h1>¡Habitacion no disponible en la fecha seleccionada, disculpa las molestias vuelve a buscar!</h1>
        <p>Tu reserva ha fallado por que alguien ya la reservo antes.</p>
        <p>Upss!!</p>
    
        <br>
        <p>Busca mas habitaciones, dale click aqui</p>
