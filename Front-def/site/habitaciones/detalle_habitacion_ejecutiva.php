<?php
    ...
    if (isset($_GET['habitacion_id'])) {
        ...
        header("Location: ../tipo de habitaciones/habitaciones_ejecutivas.php");
        exit();
    }
?>
...
<html class="wide wow-animation" lang="en">
  <head>
    <!-- Site Title-->
    <title>Habitacion Ejecutiva</title>
...
<br>
    ...
    <a href="../tipos de habitaciones/habitaciones_ejecutivas.php" class="btn btn-secondary">Volver a la lista de habitaciones</a>
</div>
<br>
