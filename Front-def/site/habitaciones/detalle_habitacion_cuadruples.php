<?php
    ...
    if (isset($_GET['habitacion_id'])) {
        ...
        header("Location: ../tipo de habitaciones/habitaciones_cuadruples.php");
        exit();
    }
?>
...
<br>
    ...
    <a href="../tipos de habitaciones/habitaciones_cuadruples.php" class="btn btn-secondary">Volver a la lista de habitaciones</a>
</div>
<br>
