<?php
    ...
    if (isset($_GET['habitacion_id'])) {
        ...
        header("Location: ../tipo de habitaciones/habitaciones_individuales.php");
        exit();
    }
?>
...
<html class="wide wow-animation" lang="en">
  <head>
    <!-- Site Title-->
    <title>Habitacion Individuales</title>
...
<br>
    ...
    <a href="../tipos de habitaciones/habitaciones_individuales.php" class="btn btn-secondary">Volver a la lista de habitaciones</a>
</div>
<br>
